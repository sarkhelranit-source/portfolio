...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  return (
    ...
    >
      ...
      />
      <style>{`
        .is-targeting .target-cursor-corner {
          border-color: #00f2fe !important;
          filter: drop-shadow(0 0 4px #4facfe) drop-shadow(0 0 8px #00f2fe);
          transition: border-color 0.2s ease-out, filter 0.2s ease-out;
        }
        .is-targeting .target-cursor-dot {
          background: linear-gradient(to right, #00f2fe, #4facfe, #f093fb) !important;
          box-shadow: 0 0 15px 4px rgba(79, 172, 254, 0.6);
          transform: translate(-50%, -50%) scale(1.5) !important;
          transition: background 0.2s ease-out, box-shadow 0.2s ease-out, transform 0.2s ease-out;
        }
        .target-cursor-corner, .target-cursor-dot {
          transition: border-color 0.2s ease-out, background 0.2s ease-out, box-shadow 0.2s ease-out, filter 0.2s ease-out, transform 0.2s ease-out;
        }
      `}</style>
    </div>
  );
