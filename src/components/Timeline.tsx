  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto pt-10 pb-6 md:pt-12 md:pb-12 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-zinc-100 max-w-4xl font-display font-bold">
          Experience
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              {item.logo ? (
                <div className="hidden md:flex md:pl-20 w-56 items-center justify-start">
